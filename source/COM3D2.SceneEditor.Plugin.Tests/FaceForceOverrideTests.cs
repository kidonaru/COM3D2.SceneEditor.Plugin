...
namespace COM3D2.SceneEditor.Plugin.Tests
{
    ...
    public class FaceForceOverrideTests
    {
        ...
        [Fact]
        public void 強制上書きキーはトグルとして描かれる()
        {
            var info = new TransformDataFaceSetting().GetCustomValueInfoMap()["forceOverride"];

            Assert.Equal(CustomValueType.BoolValue, info.type);
        }
